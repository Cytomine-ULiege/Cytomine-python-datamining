...
if __name__ == "__main__":
    ...
    if (wpath.endswith('/')):
        wpath = wpath + '/'
    cytomine_connection = cytomine.Cytomine('demo.cytomine.be', public_key, private_key, base_path='/api/',
                                            working_path=wpath, verbose=True)

    droso_terms = [6579647, 6581077, 6581992, 6583116, 6584107, 6585116, 6586002, 6587114, 6587962, 6588763, 6589668,
                   6590562, 6591526, 6592482, 6593390]
    cepha_terms = [6625929, 6626956, 6628031, 6628982, 6630085, 6630930, 6632153, 6633169, 6634164, 6635158, 6636231,
                   6637186, 6638098, 6638869, 6639680, 6640638, 6641592, 6641602, 6641610]
    zebra_terms = [6555577, 6555589, 6555603, 6555613, 6555621, 6555631, 6555631, 6555647, 6555657, 6555665, 6555675,
                   6555681, 6555691, 6555699, 6555709, 6555717, 6555727, 6555735, 6555745, 6555753, 6555761, 6555769,
                   6555777, 6555787, 6555795]
